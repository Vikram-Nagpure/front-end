...
let PitchData = []
function showData() {
    let result = fetch('https://shrktank-2.onrender.com/pitches').then(e => e.json()).then(e => {
        PitchData = e
        e.map(e => {
...
pitchCreateBtn.addEventListener('click', () => {
    ...
    let fetchPost = fetch('https://shrktank-2.onrender.com/pitches', {
        method: 'POST',
...
function deletePitch(id) {
    let delPitch = fetch(`https://shrktank-2.onrender.com/pitches/${id}`, {
        method: 'DELETE'
    })
...
function EditPitch(id) {
    fetch(`https://shrktank-2.onrender.com/pitches/${id}`).then(e => e.json()).then(e => {
...
updatePitchBtn.addEventListener('click', (e) => {
    ...
    fetch(`https://shrktank-2.onrender.com/pitches/${updatePitch.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
...
updatePricePitchPriceButton.addEventListener('click', () => {
    ...
    fetch(`https://shrktank-1.onrender.com/pitches/${priceId.id}`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
